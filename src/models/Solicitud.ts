...
class ModelSolicitud{
    private list:any = [];
    public lista = async () =>{
        this.list = await pool.query("SELECT idSolicitud, nombre, apellido, placa, descrip, Colores.descripcion, Bordados.descripcion as bordado, cantidad, fechaSolicitud,Procesos.descripcion as fase,descPago,referencia,Solicitudes.costura,Costura.texto FROM Costura,Pagos,Metodos, Usuarios,Automoviles, Colores, Bordados, Tipos, Solicitudes, Procesos Where idVehiculo=Automoviles.idAutomovil and id_material=Tipos.idTipo and id_color=Colores.idColor and id_bordado=Bordados.idBordado and Solicitudes.idUsuario=Usuarios.idUsuario and Procesos.idProceso=Solicitudes.fase and Solicitudes.fase=3 and Pagos.idSoli=Solicitudes.idSolicitud and Costura.idc=Solicitudes.costura and Pagos.tipo=Metodos.idpago ORDER BY fechaSolicitud");
        return this.list;
    };

    public listaTodos = async () => {
        this.list = await pool.query("SELECT idSolicitud,Usuarios.idUsuario, nombre, apellido, placa, descrip,fechaSolicitud, Colores.descripcion, Bordados.descripcion as bordado, cantidad, fechaSolicitud,Procesos.idProceso,Procesos.descripcion as fase,Procesos.idProceso as idfase,descPago,referencia,Solicitudes.costura,Costura.texto FROM Costura,Pagos,Metodos, Usuarios,Automoviles, Colores, Bordados, Tipos, Solicitudes, Procesos Where idVehiculo=Automoviles.idAutomovil and id_material=Tipos.idTipo and id_color=Colores.idColor and id_bordado=Bordados.idBordado and Solicitudes.idUsuario=Usuarios.idUsuario and Procesos.idProceso=Solicitudes.fase and Pagos.idSoli=Solicitudes.idSolicitud and Pagos.tipo=Metodos.idpago and Solicitudes.costura=Costura.idc and Solicitudes.fase>=3 and Solicitudes.fase<=9  ORDER BY fechaSolicitud");
        return this.list;
    }

    public listaCliente = async (id:number) =>{
        this.list = await pool.query("SELECT idSolicitud, nombre, apellido, placa, descrip, Colores.descripcion, Bordados.descripcion as bordado, cantidad, fechaSolicitud,Procesos.idProceso,Procesos.descripcion as fase,Procesos.idProceso as idfase,descPago,referencia,Solicitudes.costura,Costura.texto FROM Costura,Pagos,Metodos, Usuarios,Automoviles, Colores, Bordados, Tipos, Solicitudes, Procesos Where idVehiculo=Automoviles.idAutomovil and id_material=Tipos.idTipo and id_color=Colores.idColor and id_bordado=Bordados.idBordado and Solicitudes.idUsuario=Usuarios.idUsuario and Procesos.idProceso=Solicitudes.fase and Pagos.idSoli=Solicitudes.idSolicitud and Pagos.tipo=Metodos.idpago and Solicitudes.costura=Costura.idc and Solicitudes.idUsuario=? ORDER BY fechaSolicitud",[id]);
        return this.list;
    };

    public listaClienteByFase = async (id:number,fase1:number,fase2:number) => {
        this.list = pool.query("SELECT idSolicitud, nombre, apellido, placa, descrip, Colores.descripcion, Bordados.descripcion as bordado, cantidad, fechaSolicitud,Procesos.idProceso,Procesos.descripcion as fase,Procesos.idProceso as idfase,descPago,referencia,Solicitudes.costura,Costura.texto FROM Costura,Pagos,Metodos, Usuarios,Automoviles, Colores, Bordados, Tipos, Solicitudes, Procesos Where idVehiculo=Automoviles.idAutomovil and id_material=Tipos.idTipo and id_color=Colores.idColor and id_bordado=Bordados.idBordado and Solicitudes.idUsuario=Usuarios.idUsuario and Procesos.idProceso=Solicitudes.fase and Pagos.idSoli=Solicitudes.idSolicitud and Pagos.tipo=Metodos.idpago and Solicitudes.costura=Costura.idc and Solicitudes.idUsuario=? and Solicitudes.fase>=? and Solicitudes.fase<=? ORDER BY fechaSolicitud",[id,fase1,fase2]);
        return this.list;
    }
    ...
    public listaGerente = async (fase:number,fase2:number) =>{
        return await pool.query("SELECT idSolicitud,fechaTentativa,Costura.texto, nombre, apellido, placa, descrip, Colores.descripcion, Bordados.descripcion as bordado, cantidad, fechaSolicitud,Procesos.descripcion as fase,descPago,referencia FROM Pagos,Metodos, Usuarios,Automoviles, Colores, Bordados,Costura, Tipos, Solicitudes, Procesos Where idVehiculo=Automoviles.idAutomovil and id_material=Tipos.idTipo and id_color=Colores.idColor and id_bordado=Bordados.idBordado and Solicitudes.idUsuario=Usuarios.idUsuario and Procesos.idProceso=Solicitudes.fase and (Solicitudes.fase>=? and Solicitudes.fase<=?) and Pagos.idSoli=Solicitudes.idSolicitud and Pagos.tipo=Metodos.idpago and Costura.idc=Solicitudes.costura ORDER BY fechaSolicitud",[fase,fase2]);
    }
    
    public listaFases = async (fase1:number,fase2:number) =>{
        return await pool.query("SELECT idSolicitud,Costura.texto, nombre, apellido, placa, descrip, Colores.descripcion, Bordados.descripcion as bordado, cantidad, fechaSolicitud,Procesos.descripcion as fase,descPago,referencia FROM Pagos,Metodos, Usuarios,Automoviles, Colores, Bordados,Costura, Tipos, Solicitudes, Procesos Where idVehiculo=Automoviles.idAutomovil and id_material=Tipos.idTipo and id_color=Colores.idColor and id_bordado=Bordados.idBordado and Solicitudes.idUsuario=Usuarios.idUsuario and Procesos.idProceso=Solicitudes.fase and (Solicitudes.fase=? OR Solicitudes.fase=?) and Pagos.idSoli=Solicitudes.idSolicitud and Pagos.tipo=Metodos.idpago and Costura.idc=Solicitudes.costura ORDER BY fechaSolicitud",[fase1,fase2]);
    }

    public listatodos = async () => {
        return await pool.query("SELECT idSolicitud,fechaTentativa,Usuarios.idUsuario, nombre, apellido, placa, descrip,fechaSolicitud, Colores.descripcion, Bordados.descripcion as bordado, cantidad, fechaSolicitud,Procesos.idProceso,Procesos.descripcion as fase,Procesos.idProceso as idfase,descPago,referencia,Solicitudes.costura,Costura.texto FROM Costura,Pagos,Metodos, Usuarios,Automoviles, Colores, Bordados, Tipos, Solicitudes, Procesos Where idVehiculo=Automoviles.idAutomovil and id_material=Tipos.idTipo and id_color=Colores.idColor and id_bordado=Bordados.idBordado and Solicitudes.idUsuario=Usuarios.idUsuario and Procesos.idProceso=Solicitudes.fase and Pagos.idSoli=Solicitudes.idSolicitud and Pagos.tipo=Metodos.idpago and Solicitudes.costura=Costura.idc and Solicitudes.fase>=4 and Solicitudes.fase<=9  ORDER BY fechaSolicitud");
    }
